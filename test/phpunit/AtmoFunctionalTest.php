...
/**
 * \file    test/functional/AtmoFunctionalTest.php
 * \ingroup atmo
 ...
 * @package Testatmo
 */
class AtmoFunctionalTest extends \PHPUnit_Extensions_Selenium2TestCase
{
	...
	{
		$this->url('/custom/atmo/admin/setup.php');
		$this->authenticate();
		return $this->assertContains('atmo/admin/setup.php', $this->url(), 'Configuration page');
	}
	...
	{
		$this->url('/custom/atmo/admin/about.php');
		$this->authenticate();
		return $this->assertContains('atmo/admin/about.php', $this->url(), 'About page');
	}
	...
	public function testBoxDeclared()
	{
		...
		$this->authenticate();
		return $this->assertContains('atmowidget1', $this->source(), "Box enabled");
	}
	...
	public function testTriggerDeclared()
	{
        ...
        return $this->assertContains(
			'interface_99_modAtmo_AtmoTriggers.class.php',
	...
	public function testTriggerEnabled()
	{
        ...
        return $this->assertContains(
			'tick.png',
			$this->byXPath('//td[text()="interface_99_modAtmo_MyTrigger.class.php"]/following::img')->attribute('src'),
			"Trigger enabled"
		);
	}
