...
/**
 *	\file       atmo/atmoindex.php
 *	\ingroup    atmo
 *	\brief      Home page of atmo top menu
 */
...
$langs->loadLangs(array("atmo@atmo"));

$action=GETPOST('action', 'alpha');


// Securite acces client
if (! $user->rights->atmo->read) accessforbidden();
...
llxHeader("", $langs->trans("AtmoArea"));

print load_fiche_titre($langs->trans("AtmoArea"), '', 'atmo.png@atmo');
...
// Draft MyObject
if (! empty($conf->atmo->enabled) && $user->rights->atmo->read)
{
	$langs->load("orders");
